...
public class SpiderSpawner extends Entity implements RegularActionEntity {
    private int coolDown;
    private int roundsLeft;
    /**
     *  Spawns spiders randomly  in an open square cardinally adjacent to the spawner   
     */
    //can input coolDown as argument constructor, can be done in factory
    public SpiderSpawner(Position current, String type, DungeonMapAPI map) {
